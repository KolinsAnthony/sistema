            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de especialiadad</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    <label class="my-1 mr-2" for="busqueda">Rubro</label>
                                    ...
                                    <a href="{{route('rubro.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de rubro-->
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        function modalEditar(id) {
            ...
            const ruta = route('rubro.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('rubro.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('rubro.destroy', [id]);
