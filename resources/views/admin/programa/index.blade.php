                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de Programa</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    <label class="my-1 mr-2" for="busqueda">Programa</label>
                                    ...
                                    <a href="{{route('programa.pdf')}}" class="btn btn-danger" target="_black">Exportar PDF </a>
                                </form>
                            </div>
                        </div>
                    </div>
...
@section('javascript')
    <script>
        ...
        function search() {
            ...
            const ruta = route('programa.search');
        ...
        function modalCrear() {
            const ruta = route("programa.create");
        ...
        function guardar() {
            const ruta = route('programa.store');
        ...
        function modalEditar(id) {
            ...
            const ruta = route('programa.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('programa.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('programa.destroy', [id]);
