            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de Area</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    <label class="my-1 mr-2" for="busqueda">Area:</label>
                                    ...
                                    <a href="{{route('area.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de areas -->
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        function actualizar(id) {
            const ruta = route('area.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('area.destroy', [id]);
