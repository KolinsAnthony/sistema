            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Búsqueda de boletas</h5>
                            </div>
                            <div class="card-body">
                                <form class="form-inline" id="formulario-busqueda">
                                    <label class="my-1 mr-2" for="busqueda">Comprobantes:</label>
                                    ...
                                    <a href="{{route('comprobante.pdf')}}" class="btn btn-danger" target="_blank">Exportar PDF</a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12" id="listado">
                        <!-- Aquí se mostrará el listado de comprobantes -->
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        ...
        // Funciones de búsqueda, modales y otras acciones
        function search() {
            const busqueda = document.getElementById("busqueda").value;
            const ruta = route('comprobante.search');
        ...
        function modalCrear() {
            const ruta = route("comprobante.create");
        ...
        function guardar() {
            const ruta = route('comprobante.store');
        ...
        function modalEditar(id) {
            const ruta = route('comprobante.edit', [id]);
        ...
        function actualizar(id) {
            const ruta = route('comprobante.update', [id]);
        ...
        function confirmarEliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const ruta = route('comprobante.destroy', [id]);
